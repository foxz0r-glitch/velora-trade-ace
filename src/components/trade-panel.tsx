    ...
    <aside className="w-64 shrink-0 bg-panel border-l border-border/60 flex flex-col">
      ...
      <div className="p-4 pt-0 space-y-2.5">
        ...
        >
          ...
          <span className="relative inline-flex items-center justify-center w-6 h-6 rounded-full bg-black/25 group-hover:bg-black/35 transition-colors duration-300">
            <ArrowUp
              className="w-3.5 h-3.5 text-white/80 group-hover:text-white transition-[transform,color] duration-500 ease-out"
              strokeWidth={3}
